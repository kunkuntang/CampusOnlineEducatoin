...
<table width="993" height="1092" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
  ...
  <select name='leixing' id='leixing'>
    ...
    <option value="ppt">ppt</option>
                          ...
                          发布人：
  <input name="faburen" type="text" id="faburen" size="12" />
...
?></td>
                              <td width="55" align="center"><a href="jiaoxuekejiandetail.php?id=<?php echo mysql_result($query,$i,"id");?>">详细</a></td>
                            </tr>
                            <?php
	}
}
?>
	...
	?>
                          ...
                          <p align="center"><a href="jiaoxuekejianlist.php?pagecurrent=1">首页</a>, <a href="jiaoxuekejianlist.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="jiaoxuekejianlist.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="jiaoxuekejianlist.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>                          <p align="center">&nbsp;</p>                          
                        </td>
