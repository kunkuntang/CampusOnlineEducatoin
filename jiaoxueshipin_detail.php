...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"> 
      <td width='11%'>编号：</td><td width='39%'><?php echo mysql_result($query,0,bianhao);?></td><td width='11%'>名称：</td><td width='39%'><?php echo mysql_result($query,0,mingcheng);?></td></tr><tr><td width='11%'>课程：</td><td width='39%'><?php echo mysql_result($query,0,kecheng);?></td><td width='11%'>简介：</td><td width='39%'><?php echo mysql_result($query,0,jianjie);?></td></tr><tr><td width='11%'>视频：</td><td width='39%'><?php echo mysql_result($query,0,shipin);?></td><td width='11%'>发布人：</td><td width='39%'><?php echo mysql_result($query,0,faburen);?></td>
    <tr>
