...
<form id="form1" name="form1" method="post" action="">
  搜索: 编号：<input name="bianhao" type="text" id="bianhao" /> 名称：<input name="mingcheng" type="text" id="mingcheng" /> 课程：<input name="kecheng" type="text" id="kecheng" />
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  ...
  <?php 
    $sql="select * from jiaoxueshipin where faburen='".$_SESSION['username']."'";
...
?></td>
    <td width="90" align="center"><a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=jiaoxueshipin" onclick="return confirm('真的要删除？')">删除</a> <a href="jiaoxueshipin_updt.php?id=<?php echo mysql_result($query,$i,"id");?>">修改</a> <a href="jiaoxueshipindetail.php?id=<?php echo mysql_result($query,$i,"id");?>" target="_blank">详细</a></td>
  </tr>
  	<?php
	}
}
...
<p align="center"><a href="jiaoxueshipin_list2.php?pagecurrent=1">首页</a>, <a href="jiaoxueshipin_list2.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="jiaoxueshipin_list2.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="jiaoxueshipin_list2.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
