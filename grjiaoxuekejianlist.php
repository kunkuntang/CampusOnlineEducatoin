...
<?php include_once 'grleft.php';?></td>
  ...
  <input name="mingcheng" type="text" id="mingcheng" size="12" />
                            课程：
  <input name="kecheng" type="text" id="kecheng" size="12" />
                            类型：
  ...
  <input type="submit" name="Submit" value="查找" />
                            ...
                            <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
                              <tr>
                                ...
                                <td width="79" bgcolor='#CCFFFF'>编号</td>
                                <td width="207" bgcolor='#CCFFFF'>名称</td>
                                <td width="77" bgcolor='#CCFFFF'>课程</td>
                                <td width="36" bgcolor='#CCFFFF'>类型</td>
                                <td width="61" bgcolor='#CCFFFF'>发布人</td>
                                <td width="122" align="center" bgcolor="#CCFFFF">添加时间</td>
                                <td width="55" align="center" bgcolor="#CCFFFF">操作</td>
                              </tr>
                              <?php 
    $sql="select * from jiaoxuekejian where faburen='".$username."'";
...
?></td>
                                <td width="55" align="center"><a href="grjiaoxuekejiandetail.php?id=<?php echo mysql_result($query,$i,"id");?>&username=<?php echo $username?>">详细</a></td>
                              </tr>
                              <?php
	}
}
?>
  ...
  <input type="button" name="Submit2" onClick="javascript:window.print();" value="打印本页" />
                            ...
                            <p align="center"><a href="grjiaoxuekejianlist.php?pagecurrent=1&username=<?php echo $username?>">首页</a>, <a href="grjiaoxuekejianlist.php?pagecurrent=<?php echo $pagecurrent-1;?>&username=<?php echo $username?>">前一页</a> ,<a href="grjiaoxuekejianlist.php?pagecurrent=<?php echo $pagecurrent+1;?>&username=<?php echo $username?>">后一页</a>, <a href="grjiaoxuekejianlist.php?pagecurrent=<?php echo $pagecount;?>&username=<?php echo $username?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>                            <p align="center">&nbsp;</p>                            
                            </td>
