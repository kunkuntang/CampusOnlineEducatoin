...
<p align="center"><a href="jiaoxuekejian_list.php?pagecurrent=1">首页</a>, <a href="jiaoxuekejian_list.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="jiaoxuekejian_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="jiaoxuekejian_list.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
