...
if ($addnew=="1" )
{
	...
	$sql="update jiaoshixinxi set grgg='$content' where gonghao= '".$_SESSION['username']."'";
	mysql_query($sql);
	echo "<script>javascript:alert('操作成功!');location.href='grdx.php';</script>";
}
?>
...
if($rowscount>0)
{
$editor->Value=mysql_result($query,$i,grgg);
?>
